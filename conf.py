...
BLOG_AUTHOR = "Kelian"  # (translatable)
BLOG_TITLE = "SQS"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kelianf.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kelianf.github.io/"
BLOG_EMAIL = "kelianferhat@gmail.com"
BLOG_DESCRIPTION = "On a quest for understanding."  # (translatable)
